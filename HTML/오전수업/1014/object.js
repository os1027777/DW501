...
/*
    ...
    객체생성 : new 연산를 통해서 생성
    생성된 객체는 변수에 저장 하여 사용하는데 이때 변수를 참조변수라고한다.
...
//객체 생성 방법 1 . 객체 리터럴 방식 : 변수처럼 객체를 생성하는방식
...
var student = { 
    ...
    반:3,
    번호:2022010327,
    이름:name // 중앙선 표시된것은 권장하지않는 방식이라는 의미
};
...
music.title="라이언";
music['가수'] = "여자아이들";
music.link='<iframe width="639" height="360" src="https://www.youtube.com/embed/ilVozqUXrG4" title="펀치(PUNCH) - 영화 속에 나오는 주인공처럼 (동백꽃 필 무렾 OST) (191215 펀치 단독콘서트 드라마 같은 날) (가로버전)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';

document.write("<a href='javascript:open();'>"+ music['title']+
"  "+ music.가수+"</a>");
